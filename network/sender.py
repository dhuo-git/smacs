...
PubS_CONF = {'ipv4':'127.0.0.1' , 'pub_port': "5568", 'pubtopics':[1], 'pub_id':1, 'dly':1., 'name': 'Sender'}
#sender subscribes to topic 3 (controll channel)
SubC_CONF = {'ipv4':"127.0.0.1" , 'sub_port': "5570", 'subtopics':[3], 'sub_id':1, 'dly':1., 'name': 'Sender'}
