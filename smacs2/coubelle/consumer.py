...
compared to network/consumer, REQ-REP is deployed for N7, where consumer is server with REP
...
class Consumer:
    ...
    def open(self):
        ...
        self.rep_socket = self.context.socket(zmq.REP) #N7
        self.rep_socket.bind(f"tcp://{self.conf['ipv4c']}:{self.conf['rep_c']}")
    ...
    #receive using REQ-REP
    def respondRx(self, note, c=True):
...
#ipv4= "192.168.1.37"       #
ipv4c = "192.168.1.37"
CONF = {'ipv4':ipv4, 'sub_port': "5570", 'pub_port': "5568","ipv4c": ipv4c, "rep_c": 5555, 'key':[1,2], 'dly':1., 'maxlen': 4,  'print': True, 'mode': 0}
